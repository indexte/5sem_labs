...
public class Kernel extends Thread
{
  ...
  private List<Page> memVector = new ArrayList<>();
  private List<Instruction> instructVector = new ArrayList<>();
  ...
  public Queue<Page> physicalPages = new ArrayDeque<>();
  ...
  public void init( String commands , String config )  
  {
    ...
    List<Page> physicalPagesTemp = new LinkedList<>();
    ...
    physicalPagesTemp.sort(new PageInMemoryComparator());
    physicalPages = new ArrayDeque<>(physicalPagesTemp);
