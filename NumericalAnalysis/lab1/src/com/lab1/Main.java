...
public class Main {
    ...
    private static double secantMethod(double start, double end, double epsilon) {
        iter++;
        if(Math.abs(end - start) <= epsilon) {
            return start + (end - start)/2;
        }
        ...
        return secantMethod(end, next, epsilon);
    }
    ...
    public static void main(String[] args) {
        ...
        iter = 0;
        System.out.println("First root: x=" + secantMethod(0, 1, EPSILON));
        System.out.println("Iterations: " + iter);
        iter = 0;
        System.out.println("Second root: x=" + secantMethod(1, 2, EPSILON));
        System.out.println("Iterations: " + iter);
    }
}
