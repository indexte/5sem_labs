...
public class Main {
    ...
    private static void yakobi(SimpleMatrix A, double eps) {
        ...
        while(true) {
            System.out.println("Ітерація номер " + iteration);
            System.out.println("Матриця A(i)");
            A.print();
            ...
            System.out.println("Максимальний елемент: " + maxElem);
            ...
            System.out.println("Матриця A(i+1)");
            A.print();
        ...
        System.out.println("Власні значения:");
        ...
        for(int j=0;j<finalU.numCols();j++) {
            System.out.println(j + " власний вектор");
